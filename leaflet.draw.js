 ...
 */
        ...
        draw: {
            toolbar: {
                ...
                buttons: {
                    ...
                    marker1: 'Draw first marker',
                    marker2: 'Draw second marker'
                }
            },
            handlers: {
                circle: {
    ...
    L.DrawToolbar = L.Toolbar.extend({
        ...
        addToolbar: function (map) {
            ...
            if (this.options.marker1) {
                this._initModeHandler(
                    new L.Draw.Marker(map, this.options.marker1),
                    this._toolbarContainer,
                    buttonIndex++,
                    buttonClassPrefix,
                    this.options.marker1.title
                );
            }

            if (this.options.marker2) {
                this._initModeHandler(
                    new L.Draw.Marker(map, this.options.marker2),
                    this._toolbarContainer,
                    buttonIndex++,
                    buttonClassPrefix,
                    this.options.marker2.title
                );
            }

            if (this.options.marker3) {
                this._initModeHandler(
                    new L.Draw.Marker(map, this.options.marker3),
                    this._toolbarContainer,
                    buttonIndex++,
                    buttonClassPrefix,
                    this.options.marker3.title
                );
            }

            if (this.options.marker4) {
                this._initModeHandler(
                    new L.Draw.Marker(map, this.options.marker4),
                    this._toolbarContainer,
                    buttonIndex++,
                    buttonClassPrefix,
                    this.options.marker4.title
                );
            }

            if (this.options.marker5) {
                this._initModeHandler(
                    new L.Draw.Marker(map, this.options.marker5),
                    this._toolbarContainer,
                    buttonIndex++,
                    buttonClassPrefix,
                    this.options.marker5.title
                );
            }

            if (this.options.marker6) {
                this._initModeHandler(
                    new L.Draw.Marker(map, this.options.marker6),
                    this._toolbarContainer,
                    buttonIndex++,
                    buttonClassPrefix,
                    this.options.marker6.title
                );
            }

            if (this.options.marker7) {
                this._initModeHandler(
                    new L.Draw.Marker(map, this.options.marker7),
                    this._toolbarContainer,
                    buttonIndex++,
                    buttonClassPrefix,
            ...
            if (this.options.marker9) {
                this._initModeHandler(
                    new L.Draw.Marker(map, this.options.marker9),
                    this._toolbarContainer,
                    buttonIndex++,
                    buttonClassPrefix,
                    this.options.marker9.title
                );
            }
